...
export default function Navbar() {
  ...
  // Frosted glass triggers after 20px scroll
  useEffect(() => {
  ...
  return (
    <>
      ...
      >
        ...
        <nav
          className={cn(
            "hidden md:flex items-center gap-0.5 rounded-full px-2 py-1.5 transition-all duration-500",
            scrolled
              ? "border border-border bg-card/70 backdrop-blur-xl shadow-lg shadow-black/10"
                ...
                >
                  {moreLinks.map((item) => (
                    <a
                      ...
                      className={cn(
                        "flex items-center gap-2.5 px-3.5 py-2.5 rounded-xl text-sm transition-colors",
                        isActive(item.href)
                  ...
                  >
                    ...
                    {isActive(link.href) && (
                      <motion.span
                        ...
                        className="ml-auto h-1 w-4 rounded-full bg-primary/60"
                      />
                    )}
                  </motion.a>
                ))}
